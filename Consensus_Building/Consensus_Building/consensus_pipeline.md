...
### UMI Family Collapse Summary (Singleton families)

| Barcode | Raw UMI families | Distance=0 | Singleton=0 | Distance=1 | Singleton=1 | Distance=2 | Singleton=2 | Distance=3 | Singleton=3 | Distance=4 | Singleton=4 | Distance=5 | Singleton=5 | Distance=6 | Singleton=6 | Distance=7 | Singleton=7 | Distance=8 | Singleton=8 |
|--------|------------------:|-----------:|------------:|-----------:|------------:|-----------:|------------:|-----------:|------------:|-----------:|------------:|-----------:|------------:|-----------:|------------:|-----------:|------------:|-----------:|------------:|
